...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated andTitle:(NSString*)Title{
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        self.labelText = nil; //@"Please Wait while we retrieve your information";
		self.detailsLabelText = strTitle;
		self.opacity = 0.8f;
        self.color = nil;
